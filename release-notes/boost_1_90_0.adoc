...
** Improved the per-operation support in `async_exec()`. Requests can now
...
** Added support for authenticating users with an empty password
   ...
   Issue boost_gh:issue[redis,298].
