...
** Added a Louvain community detection algorithm for scalable modularity-based clustering (boost_gh:pr[graph,453]).
...
** Documentation: migrated and restructured pages to match the previous HTML layout, refreshed the landing and visitor pages, recovered the table of contents, and fixed the circle layout docs (boost_gh:pr[graph,469], boost_gh:pr[graph,491], boost_gh:pr[graph,509], boost_gh:pr[graph,517], boost_gh:pr[graph,519]).
