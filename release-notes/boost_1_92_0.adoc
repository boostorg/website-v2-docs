...
*** Two almost identical rectangles have no interesection (boost_gh:issue[geometry,1471]).
...
the pass:[C++] committee regarding non-heteregeneous lookup for associative containers
