...
xref:task-real-time-vehicle-control.adoc[] examines the increasing role computer systems play in the design of most vehicles now.

xref:task-aeronautical-engineering.adoc[] and xref:task-bio-tech-engineering.adoc[] are computation-intensive and regulatory-intensive engineering disciplines where the Boost libraries quiet superpower of correctness comes into its own.
