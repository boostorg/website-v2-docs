...
[circle]
* boost:mpl[]:  A Metaprogramming library that provides a framework of compile-time algorithms, sequences and metafunctions, that can greatly facilitate metaprogramming tasks.
...
* boost:preprocessor[]:  Provides tools for manipulating preprocessor directives, which can be useful in certain metaprogramming tasks.
